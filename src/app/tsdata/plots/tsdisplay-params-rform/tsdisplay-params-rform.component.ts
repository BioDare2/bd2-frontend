      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <select class="form-control" required
            ...
            >
            @for (opt of detrendingOptions; track opt; let ix = $index) {
        ...
        <div class="col-sm-3">
          <select class="form-control" required
            ...
            >
            @for (opt of alignOptions; track opt; let ix = $index) {
              <option [value]="opt.name" >{{opt.label}}</option>
            }
          </select>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <select class="form-control" required
            ...
            >
            @for (opt of normalisationOptions; track opt; let ix = $index) {
              <option [value]="opt.name" >{{opt.label}}</option>
            }
          </select>
        </div>
