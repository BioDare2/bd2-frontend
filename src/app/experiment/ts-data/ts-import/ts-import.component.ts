...
import {ExcelTSImportParameters, FileImportRequest, ImportFormat} from '../import-dom';
...
export class TSImportComponent extends ExperimentBaseComponent implements OnInit {
