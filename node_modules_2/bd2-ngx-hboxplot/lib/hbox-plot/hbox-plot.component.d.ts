...
export declare class HBoxPlotComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<HBoxPlotComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<HBoxPlotComponent, "bd2-ngx-hbox-plot", never, { "hidden": { "alias": "hidden"; "required": false; }; "data": { "alias": "data"; "required": false; }; "removed": { "alias": "removed"; "required": false; }; "domain": { "alias": "domain"; "required": false; }; "palette": { "alias": "palette"; "required": false; }; "labels": { "alias": "labels"; "required": false; }; "labelsOn": { "alias": "labelsOn"; "required": false; }; "lookAndFeel": { "alias": "lookAndFeel"; "required": false; }; "sorted": { "alias": "sorted"; "required": false; }; }, { "colors": "colors"; }, never, never, false, never>;
}
